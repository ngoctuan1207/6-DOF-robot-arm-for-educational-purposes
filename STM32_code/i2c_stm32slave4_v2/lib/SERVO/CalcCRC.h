...
//#define	_CALC_CRC_SMALL_MEMORY_

#if !defined(_CALC_CRC_SMALL_MEMORY_)
...
static unsigned short CalcCRC(unsigned char* pDataBuffer, unsigned long usDataLen);
...
#else	// if defined(_CALC_CRC_SMALL_MEMORY_)

static unsigned short CalcCRCbyAlgorithm(unsigned char* pDataBuffer, unsigned long usDataLen);
...
#define CalcCRC		CalcCRCbyAlgorithm

#endif	// _CALC_CRC_SMALL_MEMORY_
